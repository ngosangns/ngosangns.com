...
export const siteConfig: SiteConfig = {
	...
	banner: {
		...
		credit: {
			...
			text: "My public notes", // Credit text to be displayed
	...
	favicon: [
		...
		{
			src: "assets/images/ngosangns.jpg", // Path of the favicon, relative to the /public directory
...
export const profileConfig: ProfileConfig = {
	...
	links: [
		...
		// },
		{
			...
			url: "https://github.com/ngosangns",
		},
	],
};
